...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\bmetadata\x18\n" +
	" \x03(\v2 .inventory.v1.Part.MetadataEntryR\bmetadata\x12\x1d\n" +
	"\n" +
	"created_at\x18\v \x01(\tR\tcreatedAt\x12\x1d\n" +
	"\n" +
	"updated_at\x18\f \x01(\tR\tupdatedAt\x1aP\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB\x9e\x01\n" +
	"\x10com.inventory.v1B\x0eInventoryProtoP\x01Z)shared/pkg/proto/inventory/v1;inventoryv1\xa2\x02\x03IXX\xaa\x02\fInventory.V1\xca\x02\fInventory\\V1\xe2\x02\x18Inventory\\V1\\GPBMetadata\xea\x02\rInventory::V1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	4,  // 4: inventory.v1.GetPartResponse.part:type_name -> inventory.v1.Part
	0,  // 5: inventory.v1.PartsFilter.categories:type_name -> inventory.v1.Category
	7,  // 6: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	4,  // 7: inventory.v1.ListPartsResponse.parts:type_name -> inventory.v1.Part
	3,  // 8: inventory.v1.Part.MetadataEntry.value:type_name -> inventory.v1.Value
	5,  // 9: inventory.v1.InventoryService.GetPart:input_type -> inventory.v1.GetPartRequest
	8,  // 10: inventory.v1.InventoryService.ListParts:input_type -> inventory.v1.ListPartsRequest
	6,  // 11: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	9,  // 12: inventory.v1.InventoryService.ListParts:output_type -> inventory.v1.ListPartsResponse

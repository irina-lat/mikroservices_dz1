...
const file_common_v1_session_proto_rawDesc = "" +
	"\n" +
	"\x17common/v1/session.proto\x12\tcommon.v1\"z\n" +
	"\aSession\x12\x12\n" +
	...
	"\n" +
	"expires_at\x18\x04 \x01(\tR\texpiresAtB\x87\x01\n" +
	"\rcom.common.v1B\fSessionProtoP\x01Z#shared/pkg/proto/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +

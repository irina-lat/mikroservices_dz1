...
func (c *InventoryGRPCConfig) Address() string { return fmt.Sprintf("%s:%d", c.host, c.port) }
func (c *InventoryGRPCConfig) Host() string    { return c.host }
func (c *InventoryGRPCConfig) Port() int       { return c.port }